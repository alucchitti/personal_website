...
const Experience = () => {
    return (
        <div id='experience'>
            ...
            <Card imgSrc={cap1} alt={'Capital One logo'} heading={'Capital One'} subheading={'Software Engineering Summit Participant'} details={'Invited to take part in weeklong summit to attend workshops on hardware, android development, and machine learning led by Capital One Engineers.'} date={'August 2021'}/>
