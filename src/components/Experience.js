...
const Experience = () => {
    return (
        <div id='experience'>
            ...
            <Card imgSrc={cap1} alt={'Capital One logo'} heading={'Capital One'} subheading={'Software Engineer'} details={'Participating in the Technology Development Program working on customer servicing and acquisitions.'} date={'February 2023 - Present'}/>
            <Card imgSrc={cap1} alt={'Capital One logo'} heading={'Capital One'} subheading={'Software Engineer Intern'} details={'Developed an internal tool to automate access request submissions using React and Express.js saving associates over 24,000 hours a year.'} date={'June 2022 - August 2022'}/>
