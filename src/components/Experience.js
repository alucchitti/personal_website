...
const Experience = () => {
    return (
        <div id='experience'>
            ...
            <Card imgSrc={cap1} alt={'Capital One logo'} heading={'Capital One'} subheading={'Software Engineering Summit'} details={'Invited to attend weeklong software engineering summit to lear more about how Capital One leverage technology to contually produce innovate banking solutions. Participated in workshops and summit wide hackathon.'} date={'August 2021'}/>
