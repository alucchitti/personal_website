...
const Projects = () => {
    return (
        <div id='projects'>
            ...
            <Card imgSrc={crossword} alt={'Crossword Puzzle'} heading={'Crossword Puzzle Solver'} subheading={'Java'} details={'A program that recursively solves a crossword puzzle handling closed squares and predefined letters in a given board.'} date={''}/>
        </div>
    )
}
