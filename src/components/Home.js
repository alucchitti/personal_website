...
const Home = () => {
    return (
        <div id='home'>
            ...
            <p>Hello! I am a senior Computer Science and Applied Statistics student at the University of Pittsburgh. I enjoy finding new ways to solve problems using technology. Feel free to explore my portfolio to see what I've been working on recently!</p>
        </div>
    )
}
